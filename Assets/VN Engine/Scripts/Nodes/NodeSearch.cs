...
namespace VNEngine
{
    ...
    public class NodeSearch : Node
    {
        public FindObject searchingCanvas;
        // Called initially when the node is run, put most of your logic here
        public override void Run_Node()
        {
            searchingCanvas.gameObject.SetActive(true);
            searchingCanvas.search = this;
...
//            Finish_Node();
        ...
        {
            Debug.Log("Finishing Search Node");
            StopAllCoroutines();
            base.Finish_Node();
        }
    }
